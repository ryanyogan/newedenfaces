  ...
  _createClass(FooterActions, [{
    ...
    value: function getTopCharacters() {
      ...
      $.ajax({ url: '/api/characters/top' }).done(function (data) {
        ...
        _this.actions.getTopCharactersFail(xhr);
      });
    }
  }]);
...
var NavbarActions = (function () {
  function NavbarActions() {
    ...
    this.generateActions('updateOnlineUsers', 'updaetAjaxAnimation', 'updateSearchQuery', 'getCharacterCountSuccess', 'getCharacterCountFail', 'findCharacterSuccess', 'findCharacterFail');
  }
  ...
  _createClass(Navbar, [{
    ...
    value: function componentDidMount() {
      ...
      socket.on('onlineUsers', function (data) {
        _actionsNavbarActions2['default'].updateOnlineUsers(dat);
      });
...
var FooterStore = (function () {
  ...
  _createClass(FooterStore, [{
    ...
    value: function onGetTopCharactersFail(xhr) {
      toastr.error(xhr.responseJSON || xhr.responstText);
    }
  }]);
